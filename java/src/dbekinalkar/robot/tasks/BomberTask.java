...
public class BomberTask extends Task {
                ...
                if (this.r.rc.canMove(moveDir)) {
                    ...
                    switch (moveDir){
                            case SOUTHWEST:
                                ...
                                altDir = Direction.EAST;
                                break;
                            case NORTHWEST:
                                moveDir = Direction.EAST;
                                altDir = Direction.SOUTH;
                                break;
                            case NORTHEAST:
                                moveDir = Direction.SOUTH;
                                altDir = Direction.WEST;
                                break;
                            case SOUTHEAST:
                                moveDir = Direction.WEST;
                                altDir = Direction.NORTH;
                                break;
                            default:
                                altDir = Direction.NORTHWEST;
                                break;
